...
struct AudioFrame {
    ...
    ///
    /// - Parameters:
    ///   - timestamp: 비디오 타임라인 상의 위치 (초)
    ///   - sampleRate: 샘플링 주파수 (Hz)
    ///   - channels: 채널 수 (1=모노, 2=스테레오)
    ///   - format: PCM 샘플 포맷
    ///   - data: 원시 PCM 바이트 데이터
    ///   - sampleCount: 채널당 샘플 개수
    ///
...
enum AudioFormat: String, Codable {
    ...
    /// 16비트 Signed Integer (Interleaved 배치)
    ///
    /// CD 오디오 표준 형식입니다.
    ...
    /// 32비트 Signed Integer (Interleaved 배치)
    ///
    /// **특징**:
